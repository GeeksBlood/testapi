...
namespace Aguila.JWT
{
    /// <summary>
    /// TokenProviderMiddleware class for creating and validating token in the Asp.net core middleware
    /// </summary>
    public class TokenProviderMiddleware
    {
        ...
        /// <summary>
        /// This is a middleware method which will call in middleware automatically
        /// </summary>
        ...
        public Task Invoke(HttpContext context)
        {
            ...
            {
                //SecurityTokenExpiredException obj = new SecurityTokenExpiredException();
        ...
        /// <summary>
        /// This method handling exceptions
        /// </summary>
        ...
        public static long ToUnixEpochDate(DateTime date) => Convert.ToInt64(new DateTimeOffset(date));//.ToUniversalTime().ToUnixTimeSeconds();
